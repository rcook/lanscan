...
namespace Lanscan.Networking.Dns.Records
{
    ...
    public sealed class NSRecord : Record
    {
        private readonly string m_nsDName;

        public NSRecord(RR rr, RecordReader recordReader)
            : base(rr)
        {
            ...
            m_nsDName = recordReader.ReadDomainName();
        }

        public string NSDNAME
        {
            get { return m_nsDName; }
        }
