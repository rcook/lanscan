...
namespace LanscanApp.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        private List<Control> m_layoutAwareControls;
        ...
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "e"), SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "e")]
        public void StartLayoutUpdates(object sender, RoutedEventArgs e)
        {
            ...
            if (this.m_layoutAwareControls == null)
            {
                // Start listening to view state changes when there are controls interested in updates
                Window.Current.SizeChanged += this.WindowSizeChanged;
                this.m_layoutAwareControls = new List<Control>();
            }
            this.m_layoutAwareControls.Add(control);
        ...
        {
            var control = sender as Control;
            if (control == null || this.m_layoutAwareControls == null)
            {
                return;
            }
            this.m_layoutAwareControls.Remove(control);
            if (this.m_layoutAwareControls.Count == 0)
            {
                // Stop listening to view state changes when no controls are interested in updates
                this.m_layoutAwareControls = null;
                Window.Current.SizeChanged -= this.WindowSizeChanged;
            }
        }
        ...
        public void InvalidateVisualState()
        {
            if (this.m_layoutAwareControls != null)
            {
                ...
                foreach (var layoutAwareControl in this.m_layoutAwareControls)
                {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (this.m_pageKey != null)
            {
                return;
            }

            var frameState = SuspensionManager.SessionStateForFrame(this.Frame);
            this.m_pageKey = "Page-" + this.Frame.BackStackDepth;

            if (e.NavigationMode == NavigationMode.New)
            {
                // Clear existing state for forward navigation when adding a new page to the
                // navigation stack
                var nextPageKey = this.m_pageKey;
            ...
            else
            {
                ...
                // from cache
                this.LoadState(e.Parameter, (Dictionary<String, Object>)frameState[this.m_pageKey]);
            }
        }
        ...
        /// model.
        /// </summary>
        private sealed class ObservableDictionary<K, V> : IObservableMap<K, V>
        {
            ...
            private sealed class ObservableDictionaryChangedEventArgs : IMapChangedEventArgs<K>
            {
