...
namespace LanscanApp.Common
{
    ...
    internal sealed class SuspensionManager
    {
        ...
        private static readonly List<Type> KnownTypes1 = new List<Type>();
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                DataContractSerializer serializer = new DataContractSerializer(typeof(Dictionary<string, object>), KnownTypes1);
                serializer.WriteObject(sessionData, s_sessionState);
        ...
        {
            s_sessionState = new Dictionary<String, Object>();
        ...
        public static Dictionary<String, Object> SessionStateForFrame(Frame frame)
        {
            ...
            if (frameState == null)
            {
                ...
                if (frameSessionKey != null)
                {
                    ...
                    if (!s_sessionState.ContainsKey(frameSessionKey))
                    {
                        s_sessionState[frameSessionKey] = new Dictionary<String, Object>();
                    }
                    frameState = (Dictionary<String, Object>)s_sessionState[frameSessionKey];
                }
                else
                {
